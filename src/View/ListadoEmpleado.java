...
public class ListadoEmpleado extends javax.swing.JFrame {
    ...
    private void cargarDatos() {
        ...
        List<Empleados> lista = empleadosDAO.getAllEmpleados();
        for (Empleados emp : lista) {
            modeloTabla.addRow(new Object[]{
                emp.getEmpleadoID(),
                emp.getNombre(),
                emp.getApellido(),
                emp.getCargoNombre(), // Mostramos la descripción del cargo
                emp.getTelefono()
            });
        }
    }
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Debes seleccionar un empleado.", "ERROR", JOptionPane.ERROR_MESSAGE);
        return;
        }
        int id = (int) tbl_empleados.getValueAt(filaSeleccionada, 0);
